...
def main():
    ...
    if user_input_file == "1":
        ...
        transactions_from_file = pd.read_csv(PATH_TO_CSV)
    ...
    Доступные для фильтровки статусы: EXECUTED, CANCELED, PENDING"""
        ...
        user_state = str(input("Введите статус для фильтрации: ").upper())
        ...
        filtered_data = []
        for i in transactions_from_file:
    ...
    #user_date = input("Введите да или нет ").lower()
        ...
        #    filter_transaction_date = sorted(
    ...
    print(f"Всего банковских операций в выборке: {Counter(trans_word)}")
          #{len(trans_word)}\n")
